...
public class Move : MonoBehaviour {
    ...
    public float accel = 0.15f, grabRatio = 0.5f, maxSpeed = 5f,
        speedIncFac = 1.0f, speedDecFac = 1.0f, slowRate = 8f, dashDist = 5f;
    ...
    void dash(int x, int y){
        Vector3 d = transform.rotation * (new Vector3(x, 0, y));
        Debug.Log(x + " " + y);
        rb.MovePosition(transform.position + d.normalized*dashDist);
    }
